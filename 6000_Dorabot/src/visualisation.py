...
class Visualisation:
            ...
            if not DEBUG_MODE:
                ...
                for body in self.simulator.world.bodies:
                    if body.userData.type == 'wall':
                        ...
                        for a in list(self.simulator.b2_objects.keys()):
    ...
    def draw_everything(self, screen, show_grid, show_control_range, show_agent, show_agent_details, show_sensor_range):
        ...
        for port in list(self.simulator.environment.loading_ports.values()):
        ...
        for port in list(self.simulator.environment.unloading_ports.values()):
    ...
    def draw_grid(self, show_grid, screen, color):
        pixels_per_grid = int(self.pixels_per_meter / self.grids_num_per_meter)
        if show_grid:
